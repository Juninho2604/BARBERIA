...
// Mock alineado al catálogo real (junio 2026). Mismo orden y datos que
// `apps/api/prisma/seed.ts` para que dev/preview se vean idénticos a prod.
